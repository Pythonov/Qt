ADD_DRUG_EXAMPLE = {
    "target_class": "drug",
    "data": {"name": "NAME2889", "category_id": "1"},
}

ADD_DRUG_CLASS_EXAMPLE = {"target_class": "drugClass", "data": {"name": "NAME"}}

ADD_THER_USE_EXAMPLE = {"target_class": "therUse", "data": {"name": "NAME"}}

ADD_BRAND_NAME_EXAMPLE = {"target_class": "brandName", "data": {"name": "NAME"}}

ADD_CATEGORY_EXAMPLE = {"target_class": "category", "data": {"name": "CATEGORY"}}

CREATE_SINGLE_GREAT_EXAMPLE = {
    "create_drug": {"description": "Create drug", "value": ADD_DRUG_EXAMPLE},
    "create_drug_class": {
...
GET_GENE_EXAMPLE = {"target_class": "genes", "data": {}}

DELETE_DRUG_EXAMPLE = {
    "target_class": "drug",
    "data": {"list_to_delete": [{"id": "29"}, {"id": "21"}, {"id": "33"}]},
}
...
DELETE_GREAT_EXAMPLE = {
    "delete_drug": {"description": "Delete drug", "value": DELETE_DRUG_EXAMPLE},
    "delete_drug_class": {
...
GET_ALL_DRUGS = {"target_class": "drug", "data": {}}

GET_ALL_CATEG = {"target_class": "category", "data": {}}

ADD_MANY_BR_NAMES_EXAMPLE = {
    "target_class": "brandName",
    "data": {
        "list_to_create": [{"name": "NAME5"}, {"name": "NAME6"}, {"name": "NAME3"}]
    },
}
...
TIE_DRUG_EXAMPLE = {
    "target_class": "drug",
    "data": {
        "drug_id": {"name": "Абареликс", "category_id": "2"},
        "link": [{"name": "www.google.com"}],
        "drugClass": [{"name": "Антагонист ГнРГ"}],
        "brandName": [{"name": "Плэнаксис"}],
        "therUse": [{"name": "Рак простаты"}],
    },
}


GET_SINGLE_CATEG_EXAMPLE = {"target_class": "category", "data": {"id": "1"}}

GET_SINGLE_PERSON_EXAMPLE = {"target_class": "people", "data": {"id": "3"}}
